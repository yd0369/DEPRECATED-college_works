...

{
    ...
    char option_2[80] = {
        "Calculate the length of string [with max length function]"
    };
    char option_3[80] = {
        "Copy a string to another string"
    };
    char option_4[80] = {
        "Copy a number (custom number limit or range) string to another string"
    };
    char option_5[80] = {
        "Concatenate (joins) two strings"
    };
    char option_6[80] = {
        "Concatenate number(custom number limit or range) two strings"
    };
    char option_7[80] = {
    ...
    char option_13[80] = {
        "Print string number of times on console"
    };
    char option_14[80] = {
        "String Swapping"
    };
    char option_15[80] = {
        "Print each string characters one by one"
    };
    char option_16[80] = {
        "Find vowel(s) from string one by one"
    };
    char option_17[80] = {
        "Find consonant(s) from string one by one"
    };
    char option_18[80] = {
        "Print each string character(s) one by one with vowel(s) and consonant(s) status"
    };
    char option_19[80] = {
        "Find number of vowel(s) from string only"
    };
    char option_20[80] = {
        "Find number of consonant(s) from string only"
    };
